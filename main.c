...
int main(void)
{
    ...
    GPIO_setOutputHighOnPin(LED_BANK1_PORT, LED_BANK1_PIN);
    GPIO_setOutputHighOnPin(LED_BANK2_PORT, LED_BANK2_PIN);
    GPIO_setOutputHighOnPin(LED_BANK3_PORT, LED_BANK3_PIN);
    GPIO_setOutputHighOnPin(LED_BANK4_PORT, LED_BANK4_PIN);
    GPIO_setOutputHighOnPin(LED_BANK5_PORT, LED_BANK5_PIN);
    GPIO_setOutputHighOnPin(LED_BANK6_PORT, LED_BANK6_PIN);
